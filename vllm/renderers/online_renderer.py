...
class OnlineRenderer:
    ...
    def _render_responses_with_harmony(
        ...
        *,
        ...
        if previous_messages is None:
            ...
            if isinstance(descriptions, ErrorResponse):
                return descriptions
            messages.extend(
                build_harmony_preamble(
    ...
    def _get_harmony_builtin_tool_descriptions(
        ...
        tool_types: set[str],
        tool_server: "ToolServer | None",
    ) -> dict[str, ToolNamespaceConfig | None] | ErrorResponse:
        ...
        for request_name, server_name in (
            ...
            if request_name in tool_types and description is None:
                return self.create_error_response(
                    f"Built-in tool {request_name!r} is not available.",
                    err_type="invalid_request_error",
                    param="tools",
                )
